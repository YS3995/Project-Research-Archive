...
<script type="text/javascript">
	$(document).ready(function() {
		var rId = JSON.parse(localStorage.getItem("resSearch"));
		//alert(pId);
		var api = "http://localhost:8085/researchById/" + rId;
		$.get(api,function(data, status) {
			var myString = "";
			myString = myString
						+ "<h2>" + data.researchName
						+ "</h2><h5>Last updated on "
						+ data.date + "</h5><p>"
						+ data.description
						+ "</p><br><p>Readme File: </p><a href='http://localhost:8085/download/file/"
						+ data.researchPaperLocation
						+ "' data-fancybox=''><img src='images/pdfDownload.jpg' height='45' width='45'></a>";
